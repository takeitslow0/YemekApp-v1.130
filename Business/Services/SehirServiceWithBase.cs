...
{
    public interface ISehirService : IService<SehirModel, Sehir, YemekAppContext>
    {
    ...
    {
        public RepoBase<Sehir, YemekAppContext> Repo { get; set; } = new Repo<Sehir, YemekAppContext>();
