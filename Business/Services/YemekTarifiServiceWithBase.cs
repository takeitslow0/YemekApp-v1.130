...
namespace Business.Services
{
    ...
    public class YemekTarifiService : IYemekTarifiService
    {
        ...
        {
            return Repo.Query("Malzemeler").OrderBy(yt => yt.Malzemeler.Adi).ThenBy(yt => yt.Adi).Select(yt => new YemekTarifiModel() // Bunu yazdım da bende çok anlamadım
            {
                Id = yt.Malzemeler.Id,
                Adi = yt.Malzemeler.Adi,
                //Tarif = yt.Tarif,
